...
/* Portions of this comments below have been moved to controller.js */
...
collection['users'].create({
    firstName: "Quandale",
    lastName: "Dingle",
    degree: "BS Information Technoology",
    degreeCode: "BSIT",
    ...
    if (err) {
        ...
        console.log("User Quandale Dinlge saved to database")
    }
}
...
collection['users'].create({
    ...
    if (err) {
        ...
        console.log("User Noel Baroidan saved to database")
    }
}
...
collection['users'].create({
    ...
    if (err) {
        ...
        console.log("User Kevin Conroy saved to database")
    }
}
...
collection['users'].create({
    ...
    if (err) {
        ...
        console.log("User Mark Hamill saved to database")
    }
}
...
collection['posts'].create({
    ...
    reviewForFN: "Jessi",
    reviewForLN: "Oh",
    reviewCourse: "GELITPH",
    reviewTerm: "Term 1",
    reviewRating: 5,
    reviewText: "Shes entertaining and raps during class",
    posterNameFN: "Sarah",
    posterNameLN: "Parker",
    posterPfp: "https://icon-library.com/images/default-profile-icon/default-profile-icon-24.jpg",
    posterDegCode: "ABLIT",
...
collection['posts'].create({
    ...
    reviewTerm: "Term 2",
    reviewRating: 1,
    reviewText: "He doesnt talk much or teach much",
    posterNameFN: "Quandale",
    posterNameLN: "Dingle",
    posterPfp: "https://icon-library.com/images/default-profile-icon/default-profile-icon-24.jpg",
    posterDegCode: "BSIT",
    posterCollege: "College of Computer Studies",
...
collection['posts'].create({
    ...
    reviewForFN: "Brian",
    reviewForLN: "Griffin",
    reviewCourse: "GEMATMW",
    reviewTerm: "Term 3",
    reviewRating: 1,
    reviewText: "He often gives essays which is weird because this is math.",
    posterNameFN: "Noel",
    posterNameLN: "Baroidan",
    posterPfp: "https://icon-library.com/images/default-profile-icon/default-profile-icon-24.jpg",
    posterDegCode: "BSCS",
    posterCollege: "College of Computer Studies",
    likesNum: 3,
